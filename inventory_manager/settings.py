...
SECRET_KEY = 'django-insecure-%tc^$d3@dbp)mohxql@r6ce3jlgz_mk-m#8!0edx@*37#(or4)'
...
ALLOWED_HOSTS = ['arya-kusuma-tugas.pbp.cs.ui.ac.id', 'localhost', '127.0.0.1', '*']
...
CORS_ORIGIN_WHITELIST = ['https://arya-kusuma-tugas.pbp.cs.ui.ac.id']
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'], # Menambahkan template di root folder
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
